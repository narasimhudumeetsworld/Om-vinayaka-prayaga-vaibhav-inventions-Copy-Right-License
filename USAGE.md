...
3. Add reference to this repository as the authoritative source

### Option 3: Package.json (for Node.js projects)
```json
{
...
Add this header to source code files:
...
This license repository serves as the single source of truth. Check back regularly for updates to license terms that may affect your projects.